...
### Install
Open a terminal and change the current working directory to where you downloaded the `goalmodeling` wheel file. Then install the most recent wheel for goalmodeling using pip3. A example is shown below for release 0.1.3 of goalmodeling.

```
pip3 install --no-index goalmodeling-0.1.3-py3-none-any.whl
``` 
